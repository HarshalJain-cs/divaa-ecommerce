  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="relative h-[60vh] min-h-[500px]">
        <img
          src="https://www.giva.co/cdn/shop/files/Birthday_Gifts_1.webp?v=1761650231&width=750"
          alt="Birthday Gifts"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-5xl md:text-6xl font-bold mb-4">Birthday Gifts</h1>
            <p className="text-xl md:text-2xl text-slate-100">Make Their Day Sparkle</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-slate-600 mb-8">
            We're creating a delightful collection of birthday gifts in silver.
          </p>
          <p className="text-lg text-slate-500 mb-12">
            Thoughtful jewelry pieces that make birthdays unforgettable.
          </p>
          <Link
