          ...
          {categories.map((category) => (
            ...
            >
              ...
              <div className="aspect-square overflow-hidden relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 text-white z-10 transform translate-y-0 group-hover:-translate-y-2 transition-all duration-300">
                  <h3 className="text-base md:text-lg font-bold mb-1 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] group-hover:text-rose-pink-light transition-colors duration-300">
                    {category.name}
                  </h3>
                  <p className="text-xs md:text-sm text-white/90 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] opacity-80 group-hover:opacity-100 transition-opacity duration-300">
